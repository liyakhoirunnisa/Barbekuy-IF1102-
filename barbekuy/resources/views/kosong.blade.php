...
<html lang="id"> <!-- Tag root HTML, atribut lang="id" artinya bahasa dokumen Indonesia -->

<head> <!-- Bagian head: berisi metadata, judul halaman, dan link CSS/JS -->
    <meta charset="UTF-8"> <!-- Set encoding karakter ke UTF-8 -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> <!-- Membuat layout responsif di perangkat mobile -->
    <title>Pemesanan</title> <!-- Judul halaman yang tampil di tab browser -->

    {{-- Masih pakai Tailwind & Iconify & Bootstrap Icons (untuk ikon), tapi styling utama pakai CSS di bawah --}} <!-- Komentar Blade menjelaskan penggunaan library CSS/ikon -->
    <script src="https://cdn.tailwindcss.com"></script> <!-- Memuat Tailwind CSS dari CDN -->
    <script src="https://code.iconify.design/3/3.1.0/iconify.min.js"></script> <!-- Memuat library Iconify untuk ikon -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet"> <!-- Memuat Bootstrap Icons -->
...
<body class="body-pemesanan"> <!-- Body halaman dengan kelas khusus styling pemesanan -->
    ...
    </script> <!-- Akhir blok JavaScript -->
</body> <!-- Akhir body halaman -->
