    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('images/logo.png') }}" alt="Barbekuy Logo">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center">
                    ...
                    {{-- 🧺 Ikon keranjang + notifikasi jumlah item --}}
                    <li class="nav-item position-relative">
                        <a href="{{ url('/keranjang') }}" class="nav-keranjang">
                            <i class="bi bi-cart3"></i> {{-- diganti dari bi-basket ke bi-cart3 --}}
                    ...
                    <li class="nav-item ms-lg-3">
                        <a href="{{ url('/login') }}" class="btn btn-login text-white">Masuk</a>
                    </li>
                </ul>

                {{-- Search bar versi mobile --}}
                <form class="d-lg-none mt-3" action="{{ url('/search') }}" method="GET">
