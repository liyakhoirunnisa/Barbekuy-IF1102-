...
<head>
    ...
    <title>Riwayat Pemesanan - Disewa</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="order-card">
            ...
            <div class="product">
                <img src="images/bbq.jpg" alt="Paket Alat BBQ">
        ...
        <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
            <div class="order-header-popup">
                <div class="order-date">
                    <span class="iconify" data-icon="mdi:calendar"></span> Tanggal 15–16 Oktober 2025
                </div>
            ...
            <div class="modal-product">
                <img src="{{ asset('images/bbq.png') }}" alt="Paket Alat BBQ">
                <div class="info">
                    <h4>Paket Alat BBQ</h4>
                    <p>x1</p>
