...
.topbar a img {
  width: 28px;   /* 🔹 ukuran diperbesar dari 26px jadi 32px */
  height: 28px;
  vertical-align: middle;
  position: relative;
  top: 2px;      /* bisa disesuaikan 0–3px agar benar-benar sejajar */
  filter: brightness(0) invert(1);
  cursor: pointer;
  transition: 0.3s;
}
...
<body>
  ...
  <aside class="sidebar">
    ...
    <div class="menu">
      ...
      <a href="#" class="menu-item active"><img src="{{ asset('images/pembayaran.png') }}"> Pembayaran</a>
      ...
      <div class="content-box">
        ...
        <div class="filters">
          ...
          <div class="icon-actions">
            <img src="{{ asset('images/icon-edit.png') }}" alt="Edit" title="Edit data yang dipilih">
            <img src="{{ asset('images/icon-delete.png') }}" alt="Hapus" title="Hapus data yang dipilih">
          </div>
        </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    const deleteIcon = document.querySelector('.icon-actions img[alt="Hapus"]');
