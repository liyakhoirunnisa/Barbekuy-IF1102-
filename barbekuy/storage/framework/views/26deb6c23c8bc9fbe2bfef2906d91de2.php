...
<head>
    ...
    <style>
        ...
        .register-right {
            ...
            background-image: url('<?php echo e(asset("images/loginpage.png")); ?>');
    ...
    <div class="register-card">
        <div class="register-left">
            ...
            <div class="logo-container">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Barbekuy" class="logo">
            </div>

            <!-- ✅ Tombol kembali -->
            <a href="<?php echo e(url('/login')); ?>" class="btn-back mb-3">&larr; Kembali</a>
            ...
            <form method="POST" action="<?php echo e(route('daftar')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nama lengkap" required>
                </div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Masukkan email" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-3">
                <p>Sudah punya akun? <a href="<?php echo e(url('/login')); ?>">Masuk</a></p>
...
<?php /**PATH D:\barbekuy\resources\views/auth/daftar.blade.php ENDPATH**/ ?>