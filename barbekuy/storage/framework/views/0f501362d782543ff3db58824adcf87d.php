    ...
    <main class="max-w-3xl mx-auto p-6 space-y-6 pt-4">
        ...
        <div class="bg-white rounded-2xl shadow p-4">
            ...
            <div class="flex items-center gap-4 border rounded-xl p-3">
                <img src="<?php echo e(asset('images/ber4extra.png')); ?>" alt="Produk" class="w-24 h-24 object-cover rounded-lg">
                <div class="flex-1">
...
<?php /**PATH D:\barbekuy\resources\views/pemesanan.blade.php ENDPATH**/ ?>