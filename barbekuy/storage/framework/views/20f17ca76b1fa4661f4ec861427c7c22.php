...
<head>
    ...
    <title>Riwayat Pemesanan - Selesai</title>
...
<body>
    ...
    <?php echo $__env->make('layouts.navbarRiwayat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="content">
        <!-- ✅ Kartu 2 (Sedang Proses) -->
        <div class="order-card">
            ...
            <div class="product">
                <img src="<?php echo e(asset('images/ber4extra.png')); ?>" alt="Paket Slice Ber-4 Xtra">
            ...
            <div class="product">
                <img src="<?php echo e(asset('images/ber6extra.png')); ?>" alt="Paket Slice Ber-6 Xtra">
                <div class="product-info">
    ...
    <div id="detailModal2" aria-hidden="true">
        <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
            ...
            <div class="modal-section">
                ...
                <p>Sumampir Kulon, Sumampir, Purwokerto Utara, Banyumas Regency, Central Java 53125</p>
            </div>
...
</html><?php /**PATH D:\barbekuy\resources\views/riwayatSelesai.blade.php ENDPATH**/ ?>