        ...
        <div class="col-md-6">
          <article class="d-flex align-items-center justify-content-between">
            <div class="flex-grow-1 me-3">
              <h5 class="fw-semibold mb-1"><?php echo e($it['name']); ?></h5>
              <p class="fw-bold mb-1" style="color: #751A25;">Rp<?php echo e(number_format($it['price'], 0, ',', '.')); ?></p>
              <small class="text-muted d-block mb-2"><?php echo e($it['desc']); ?></small>
              <div class="d-flex align-items-center gap-2 mt-2">
                  <!-- Ikon Troli -->
                  <a href="<?php echo e(url('/keranjang')); ?>" class="ikon-keranjang">
                      <i class="bi bi-cart3 fs-5"></i>
                  </a>


                  <!-- Tombol utama: Beli Sekarang -->
                  <a href="<?php echo e(url('/pemesanan')); ?>" class="btn-beli">
                      Beli
                  </a>
              </div>
            </div>
            ...
            <div class="position-relative">
              <img src="<?php echo e(asset('images/'.$it['img'])); ?>" alt="<?php echo e($it['name']); ?>">
              <span class="badge-price"><?php echo e($it['badge']); ?></span>
            </div>
          </article>
        </div>
...
</html><?php /**PATH D:\barbekuy\resources\views/menu.blade.php ENDPATH**/ ?>