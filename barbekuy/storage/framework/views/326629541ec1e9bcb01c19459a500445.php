    ...
    <section id="tentang" class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <img src="<?php echo e(asset('images/loginpage.png')); ?>" 
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-4">
                    <div class="card menu-card">
                        <img src="<?php echo e(asset('images/ber4extra.png')); ?>" class="card-img-top" alt="Paket Slice Ber-4 Extra">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card menu-card">
                        <img src="<?php echo e(asset('images/ber6extra.png')); ?>" class="card-img-top" alt="Paket Slice Ber-4 Extra">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card menu-card">
                        <img src="<?php echo e(asset('images/ber10extra.png')); ?>" class="card-img-top" alt="Paket Slice Ber-4 Extra">
                        <div class="card-body">
    ...
    <section id="testimoni" class="container text-center py-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4 mb-4">
                <div class="p-4 rounded-4 shadow-sm" style="background-color: #751A25; color: white; text-align: left;">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo e(asset('images/profile1.jpg')); ?>" alt="Profil"
            ...
            <div class="col-md-4 mb-4">
                <div class="p-4 rounded-4 shadow-sm" style="background-color: #751A25; color: white; text-align: left;">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo e(asset('images/profile2.jpg')); ?>" alt="Profil"
                            class="rounded-circle me-3" width="40" height="40" style="object-fit: cover;">
                        <div>
                            <h6 class="mb-0 fw-semibold">Theresa Jordan</h6>
                        </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="p-4 rounded-4 shadow-sm" style="background-color: #751A25; color: white; text-align: left;">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo e(asset('images/profile3.jpg')); ?>" alt="Profil"
                            class="rounded-circle me-3" width="40" height="40" style="object-fit: cover;">
                        <div>
                            <h6 class="mb-0 fw-semibold">Theresa Jordan</h6>
                        </div>
        ...
        <div class="text-center mt-2">
            <a href="<?php echo e(url('ulasan')); ?>" class="btn-lihat-lebih">
                Lihat Lebih Banyak
        ...
        <div class="container">
            <div class="row align-items-start mb-4">
                ...
                <div class="col-md-4 text-center text-md-start mb-4 mb-md-0">
                    <img src="<?php echo e(asset('images/logoputih.png')); ?>" alt="Barbekuy Logo" style="width: 160px;">
                ...
                <div class="col-md-4 text-md-start">
                    ...
                    <p class="mb-0">
                        ...
                        <!-- Link ke WhatsApp -->
                        <a href="https://wa.me/6281215310817" 
                        target="_blank" 
            ...
            <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                ...
                <!-- Chat Kami -->
                <div>
                    <a href="<?php echo e(url('/chat')); ?>" class="text-white text-decoration-none d-flex align-items-center justify-content-center">
...
<?php /**PATH D:\barbekuy\resources\views/beranda.blade.php ENDPATH**/ ?>